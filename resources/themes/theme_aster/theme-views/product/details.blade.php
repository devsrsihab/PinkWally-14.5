                                        ...
                                        <div class="pd-img-wrap position-relative h-100">
                                            ...
                                            <div class="mt-2 user-select-none">
                                                <div class="quickviewSliderThumb2 swiper-container position-relative ">
                                                    ...
                                                    <div
                                                        class="swiper-button-next swiper-quickview-button-next size-1-5rem">
                                                    </div>
                                                    <div
                                                        class="swiper-button-prev swiper-quickview-button-prev size-1-5rem">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="product-details-content position-relative">
                                            <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
                                                ...
                                                @elseif($product->discount > 0)
                                                    <span class="product__save-amount">{{ translate('save') }}
                                                        {{ Helpers::currency_converter($product->discount) }}</span>
                                                @endif
                                            </div>
                                                ...
                                                <div class="">
                                                                        ...
                                                                        <li>
                                                                            <label>
                                                                                <input type="radio" hidden=""
                                                                                    id="{{ $product->id }}-color-{{ str_replace('#', '', $color->color) }}"
                                                                                    name="color"
                                                                                    value="{{ $color->color }}"
                                                                                    {{ $key == 0 ? 'checked' : '' }}>
                                                                                <span
                                                                                    class="color_image_label color_variants rounded-circle focus-preview-image-by-color p-0 {{ $key == 0 ? 'color_variant_active' : '' }}"
                                                                                    style="background: url('{{ asset("storage/product/{$color->image_name}") }}') no-repeat center center / cover;"
                                                                                    for="{{ $product->id }}-color-{{ str_replace('#', '', $color->color) }}"
                                                                                    data-slide-id="preview-box-{{ str_replace('#', '', $color->color) }}"
                                                                                    id="color_variants_preview-box-{{ str_replace('#', '', $color->color) }}">
                                                                                    <input type="hidden"
                                                                                        name="color_image"
                                                                                        value={{ asset("storage/product/{$color->image_name}") }}>
                                                                                </span>
                                                                            </label>
                                                    ...
                                                    <div class="d-flex gap-4 flex-wrap align-items-center mb-4">
                                                        ...
                                                        <div class="quantity quantity--style-two">
                                                            ...
                                                            <span class="quantity__plus single-quantity-plus"
                                                    ...
                                                    <div class="mx-w d-flex flex-wrap gap-3 mt-4 width--24rem">
                                                        ...
                                                        @else
                                                            ...
                                                            <button type="button" class="btn btn-secondary fs-16 buy-now"
                                                ...
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="border-0 text-capitalize">
                                                            {{ translate('details_description') }}</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                                    ...
                                                                    @isset($review->attachment)
                                                                        <div
                                                                            ...
                                                                            @foreach (json_decode($review->attachment) as $img)
                                                                                <a href="{{ getValidImage(path: 'storage/app/public/review/' . $img, type: 'product') }}"
                                                                                    class="custom-image-popup mx-3">
                                    ...
                                    <div class="p-2 overlay shop-bg-card"
                                        ...
                                        <div class="media flex-wrap gap-3 p-2">
                                            <div class="avatar border rounded-circle size-3-437rem get-view-by-onclick cursor-pointer aspect-1 overflow-hidden d-flex align-items-center"
                                                data-link="{{ route('shopView', [$product->seller->id]) }}">
                                            ...
                                            <div class="media-body d-flex flex-column gap-2 text-absolute-whtie get-view-by-onclick"
                                                ...
                                                <div class="d-flex flex-column gap-1 justify-content-start">
                                                    ...
                                                    <h6 class="fw-semibold">{{ $productsForReview->count() }}
                                                        {{ translate('products') }}</h6>
                                                </div>
                                ...
                                <div class="p-2 overlay shop-bg-card"
                                    ...
                                    <div class="media flex-wrap gap-3 p-2">
                                        ...
                                        <div class="media-body d-flex flex-column gap-2 text-absolute-whtie">
                                            <div class="d-flex flex-column gap-1 justify-content-start">
                                                <h5 class="cursor-pointer get-view-by-onclick"
...
@push('script')
    ...
    <script>
        if ($("#quickViewModal").length < 2) {

                /****************** selected color event ******************/
                const colorImageContainer =
                    document.querySelector(".color_image_label"); // Change 'parentElementId' to your parent element's ID
                const firstColorImageInput = colorImageContainer.querySelector(
                    'input[name="color_image"]'
                );
                let selectedColorImageValue = firstColorImageInput ?
                    firstColorImageInput.value :
                    null;

                const selectedColorImageObj = {
                    name: "color_image",
                    value: selectedColorImageValue,
                };

                $(".color_image_label").on("click", function() {
                    selectedColorImage = $(this)
                        .find('input[name="color_image"]')
                        .val();
                    selectedColorImageObj.value = selectedColorImage;
                    console.log(selectedColorImageObj.value);
                });


                function addToCart(form_id, redirect_to_checkout = false) {
                    const cartFoirmSr = $("#" + form_id).serializeArray();
                    const filteredCart = cartFoirmSr.filter(
                        (item) => item.name !== "color_image"
                    );

                    // Push selectedColorImageObj into filteredCart
                    filteredCart.push(selectedColorImageObj);
                    if (
                ...
                if (minValue >= valueCurrent) {
                    ...
                    try {
                        if (productQty.data('details-page')) {
                            ...
                            productQty.parent().find(".quantity__minus").html(
