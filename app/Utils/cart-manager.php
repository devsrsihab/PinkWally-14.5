...
class CartManager
{
    ...
    public static function add_to_cart($request, $from_api = false)
    {
        ...
        $cart['color_image']    = $request->has('color_image') ? $request['color_image'] : null;
        // $color_image_req = $request->has('color_image') ? $request['color_image'] : null;
        // $insertion = '/app/public';
        // $position = strpos($color_image_req, '/storage');
        // $newUrl = substr_replace($color_image_req, $insertion, $position + strlen('/storage'), 0);
        // $cart['color_image']    = $newUrl;
